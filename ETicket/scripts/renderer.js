...
eTicketModule.renderConfirmation = function () {
    ...
    eTicketModule.UIEements.sections.confirmReciept.innerHTML = "Hi " 
        + eTicketModule.currentSelection.userName 
        + ",<br><br> You have selected " 
        + eTicketModule.currentSelection.noOfTickets 
        + " tickets for following movie <br>Movie:  \"" 
        + eTicketModule.currentSelection.movieName 
        + "\" <br>Theatre :" 
        + eTicketModule.currentSelection.theatre 
        + " <br> On " + eTicketModule.currentSelection.movieDate 
        + " at " 
        + eTicketModule.currentSelection.show;
...
eTicketModule.initiateUIElements = function () {
    eTicketModule.UIEements = {
        'sections': {
            ...
            userDataForm: document.getElementsByClassName("user-data-form-container")[0],
